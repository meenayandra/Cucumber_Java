Feature: IDA_RealID
  ...
  As a user
  I want to be able to create Real ID card in the system
  

  Background:
    Given user login with valid credentials
    
    @regression @IDA_RealID
...
Examples:
    ...
    |IDA|11152019 |Real     |A         |TESTER  |JR    |07031981|Sacramento|CA   |P     |320322555|D       |M     |BLK |GRY|5   |10    |145   |Z      |AA      |N           |95818|2415 1ST AVE|30    |
